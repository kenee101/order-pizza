...
function Order() {
  ...
  return (
    <div className="space-y-8 px-4 py-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 bg-stone-400 p-6">
      ...
      <ul className="divide-y divide-stone-500 border-y border-y-stone-500">
        {cart.map((item) => (
          <OrderItem
            item={item}
            key={item.pizzaId}
      ...
      <div className="space-y-2 bg-stone-400 p-6">
